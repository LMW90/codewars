...
function animals(heads, legs){
  ...
  let result = []
  // loop through amount of chickens
  for (let chickens = 0; chickens <= heads; chickens++) {
    // calculate cows
    let cows = heads - chickens
    // if valid solution, save animal quantities and break
  ...
  // if there was a valid solutin return, else return no solutions
  return result.length ? result : "No solutions"
}