...
*/
function checkDigit(number, idx1, idx2, digit) {
  // make a snipper out of the number
  let snippet = number.toString().slice(Math.min(idx1, idx2),Math.max(idx1, idx2)+1);
  // test the snippet for digit's presence
