...
function solve(a, b) {
  ...
  // build return string and return
  let tailString
  if (aliceScore === bobScore) tailString = 'that looks like a "draw"! Rock on!';
  if (aliceScore > bobScore) tailString = 'Alice made "Kurt" proud!'
  if (bobScore > aliceScore) tailString = 'Bob made "Jeff" proud!'
  return `${aliceScore}, ${bobScore}: ${tailString}`;
}