...
Array.prototype.all = function (p) {
  // return false if predicate returns false for any of items, true otherwise
...
Array.prototype.none = function (p) {
  // return false if predicate returns true for any of items, true otherwise
  for (let element of this) {
    if (p(element)) return false;
  }
  return true;
...
Array.prototype.any = function (p) {
  // return true if predicate returns true for any of items, fasle otherwise
  for (let element of this) {
