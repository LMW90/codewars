...
function automorphic(n) {
  // calculate sqared input and convert to string along the input
  let squaredNumber = (n**2).toString();
  n = n.toString();
  // test if last digits equal to input and return
  return (n == squaredNumber.slice(-n.length)) ? "Automorphic" : "Not!!";
}