/* ou are given a string representing a website's address. To calculate the IP4 address you must convert all the characters into ASCII code, then calculate the sum of the values.
...
*/
f=i=>[1,2,3,4].map(e=>e*i.split('').reduce((a,v)=>a+=v.charCodeAt(),0)%256)